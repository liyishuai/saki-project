...
declare class GameSprite extends Sprite {
    ...
    opacity: number;
    /**
     * 旋转度1 最终旋转度rotation = rotation1 + rotation2
     */
    rotation1: number;
    /**
     * 旋转度2 最终旋转度rotation = rotation1 + rotation2
     */
    rotation2: number;
    /**
     * 是否允许使用滤镜
    ...
    gameFilters: Filter[];
    /**
     * 追加一个滤镜，已存在的则忽略，支持滤镜叠加，以及子节点会自动叠加父节点的滤镜效果
     * @param gameFilter 滤镜
     */
    appendGameFilter(gameFilter: Filter): void;
    /**
     * 减少一个滤镜，滤镜不存在则忽略
     * @param gameFilter 滤镜
     */
    subtractGameFilter(gameFilter: Filter): void;
    /**
     * 更改色调
     * @param r 红色+ -255~255
     * @param g 绿色+ -255~255
